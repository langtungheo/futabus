	...
	return (
		<div className="footer" style={{ backgroundColor: '#f6f6f6' }}>
				...
				>
					<div className="pl-4 lg:pl-0 pr-8 md:col-span-2 lg:col-span-1">
						...
						<div className="flex md:justify-between">
							<a
								href="tel:19001067"
								className="hover:text-red-600 text-3xl font-bold text-pre"
							>
								1900 6067
							</a>
							<a href="/">
								<img
									className="ml-4 xs:ml-32 md:ml-0"
									src="./images/icon/DaDangKy.png"
									alt=""
								/>
							</a>
						</div>
						<div className="desc mb-5">
							<p className="font-medium text-gray-600 tracking-tight mb-0">
								CÔNG TY CỔ PHẦN XE KHÁCH PHƯƠNG TRANG FUTA BUS
								LINES
							</p>
							<p className="font-medium text-gray-600 mb-0">
								{' '}
								Địa chỉ: 468-468A Lê Văn Lương, P.Tân Phong,
								Q.7, TP Hồ Chí Minh.{' '}
							</p>
							<p className="font-medium text-gray-600">
								Email :{' '}
								<a
									href="email:hotro@futabus.vn"
									className="hover:text-pre text-pre"
								>
									hotro@futabus.vn
								</a>
							</p>
						...
						<div className="flex justify-items-center lg:justify-between">
							<div className="">
								<h2 className="uppercase font-semibold text-pre">
							...
							<div className="lg:ml-0">
								...
								<div className="flex justify-between">
									<a
										...
										target="_blank"
										rel="noreferrer"
										className="mr-3 bg-gray-900 flex items-center justify-center py-1 px-3 rounded-xl text-white hover:text-white"
									>
										<img
											className="mr-1"
									...
									<a
										...
										target="_blank"
										rel="noreferrer"
										style={{ backgroundColor: '#4db515' }}
										className="flex items-center justify-center py-1 px-3 rounded-xl text-white hover:text-white"
									>
										<img
											className="mr-1"
					...
					<div className="md:grid-cols-1 px-4">
						<h2 className="text-pre font-semibold">
							FUTA Bus Line
						</h2>
						<div className="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
							<div className="list-item1">
								<div className="py-1">
									<a
										href="/"
										className="flex gap-1 items-center text-gray-500 hover:text-gray-500"
									>
										<img
											className="w-2 h-3"
											src="./images/icon/double-right-arrow.png"
											alt=""
										/>
				...
				>
					<div className="w-full flex xs:justify-center">
						<img
							...
							src="./images/logo/logo-footer_1.png"
							alt=""
						/>
					</div>
					<div className="w-full flex xs:justify-center">
						<img
							className="w-1/2 md:w-3/4"
							src="./images/logo/logo-footer_2.png"
							alt=""
						/>
					</div>
					<div className="w-full flex xs:justify-center">
						<img
							className="w-1/2 md:w-3/4"
							src="./images/logo/logo-footer_3.png"
							alt=""
						/>
					</div>
					<div className="w-full flex xs:justify-center">
						<img
							className="w-1/2 md:w-3/4"
							src="./images/logo/logo-footer_4.png"
							alt=""
						/>
					</div>
				</div>
			...
			<div className="w-full flex justify-center items-center mb-4">
				...
				>
					<p className="license text-gray-500 tracking-tight text-center">
						© 2021 | Bản quyền thuộc về Công ty Cổ Phần Xe Khách
						Phương Trang FUTA Bus Lines | www.futabus.vn | Chịu
						trách nhiệm nội dung: Đinh Văn Huỳnh
					</p>
